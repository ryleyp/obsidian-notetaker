...
- Contribution: what the CSM personally did, opened with a real verb — defined, coordinated, advised, resolved, escalated, mapped, validated, introduced, documented, secured, drove, scoped. "Attended", "joined", "was present" are not contributions. Never claim sole ownership of work the wider account team did: when the FAE or AM led, say so and state the CSM's own part. When the sources show no CSM contribution beyond being in the room, write "Contribution: None beyond attendance" rather than inventing one.
